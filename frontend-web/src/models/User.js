...
export const UserRoleDisplayNames = Object.freeze({
 ...
 */
export class User {
    constructor({ id, username, fullName, email, role, photoUrl = null, phone = null, createdAt, stats }) {
        this.id = id || '';
    ...
    toJson() {
        return {
            ...
            email: this.email,
            role: UserRoleDisplayNames[this.role] || this.role,
